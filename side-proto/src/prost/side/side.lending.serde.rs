// @generated
#[cfg(feature = "serde")]
impl serde::Serialize for AuthorizationDeposits {
    #[allow(deprecated)]
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("side.lending.AuthorizationDeposits", len)?;
        if !self.deposit_txs.is_empty() {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for AuthorizationDeposits {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &["deposit_txs", "depositTxs"];
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = AuthorizationDeposits;

            fn expecting(&self, formatter: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                formatter.write_str("struct side.lending.AuthorizationDeposits")
            }

            fn visit_map<V>(
                self,
                mut map_: V,
            ) -> core::result::Result<AuthorizationDeposits, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(AuthorizationDeposits {
                    deposit_txs: deposit_txs__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct(
            "side.lending.AuthorizationDeposits",
            FIELDS,
            GeneratedVisitor,
        )
    }
...
impl serde::Serialize for Loan {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.authorization_deposits.is_empty() {
            len += 1;
        }
        ...
        if !self.authorization_deposits.is_empty() {
            struct_ser.serialize_field("authorizationDeposits", &self.authorization_deposits)?;
        }
        if !self.collateral_amount.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "authorizationDeposits" | "authorization_deposits" => {
                                Ok(GeneratedField::AuthorizationDeposits)
                            }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                V: serde::de::MapAccess<'de>,
            {
                ...
                let mut authorization_deposits__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::AuthorizationDeposits => {
                            if authorization_deposits__.is_some() {
                                return Err(serde::de::Error::duplicate_field(
                                    "authorizationDeposits",
                                ));
                            }
                            authorization_deposits__ = Some(map_.next_value()?);
                        }
                ...
                Ok(Loan {
                    ...
                    authorization_deposits: authorization_deposits__.unwrap_or_default(),
...
#[cfg(feature = "serde")]
impl serde::Serialize for MsgSubmitLiquidationSignatures {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> core::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("side.lending.MsgSubmitLiquidationSignatures", len)?;
        if !self.sender.is_empty() {
            struct_ser.serialize_field("sender", &self.sender)?;
        }
        if !self.loan_id.is_empty() {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for MsgSubmitLiquidationSignatures {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MsgSubmitLiquidationSignatures;

            fn expecting(&self, formatter: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                formatter.write_str("struct side.lending.MsgSubmitLiquidationSignatures")
            }

            fn visit_map<V>(
                self,
                mut map_: V,
            ) -> core::result::Result<MsgSubmitLiquidationSignatures, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
                ...
                Ok(MsgSubmitLiquidationSignatures {
                    sender: sender__.unwrap_or_default(),
                    loan_id: loan_id__.unwrap_or_default(),
                    signatures: signatures__.unwrap_or_default(),
                })
...
#[cfg(feature = "serde")]
impl serde::Serialize for MsgSubmitLiquidationSignaturesResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> core::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer
            .serialize_struct("side.lending.MsgSubmitLiquidationSignaturesResponse", len)?;
        struct_ser.end()
    }
}
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for MsgSubmitLiquidationSignaturesResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MsgSubmitLiquidationSignaturesResponse;

            fn expecting(&self, formatter: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                formatter.write_str("struct side.lending.MsgSubmitLiquidationSignaturesResponse")
            }

            fn visit_map<V>(
                self,
                mut map_: V,
            ) -> core::result::Result<MsgSubmitLiquidationSignaturesResponse, V::Error>
            where
                V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
                ...
                Ok(MsgSubmitLiquidationSignaturesResponse {})
            }
        }
        deserializer.deserialize_struct(
            "side.lending.MsgSubmitLiquidationSignaturesResponse",
            FIELDS,
            GeneratedVisitor,
        )
    }
