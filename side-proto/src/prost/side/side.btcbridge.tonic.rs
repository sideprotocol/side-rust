...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn query_chain_tip(
            ...
            tonic::Response<super::QueryChainTipResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("side.btcbridge.Query", "QueryBlockHeaderByHeight"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("side.btcbridge.Query", "QueryBlockHeaderByHash"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn query_fee_rate(
            ...
            tonic::Response<super::QueryFeeRateResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("side.btcbridge.Query", "QueryWithdrawalNetworkFee"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn query_withdraw_requests_by_address(
            ...
            request: impl tonic::IntoRequest<
                super::QueryWithdrawRequestsByAddressRequest,
            >,
        ) -> core::result::Result<
        ...
        pub async fn query_pending_btc_withdraw_requests(
            &mut self,
            request: impl tonic::IntoRequest<
                super::QueryPendingBtcWithdrawRequestsRequest,
            >,
        ) -> core::result::Result<
        ...
        pub async fn query_signing_requests(
            ...
            tonic::Response<super::QuerySigningRequestsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("side.btcbridge.Query", "QuerySigningRequests"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn query_utx_os(
            ...
            tonic::Response<super::QueryUtxOsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn query_utx_os_by_address(
            ...
            tonic::Response<super::QueryUtxOsByAddressResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("side.btcbridge.Query", "QueryUTXOsByAddress"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn query_dkg_request(
            ...
            tonic::Response<super::QueryDkgRequestResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn query_dkg_requests(
            ...
            tonic::Response<super::QueryDkgRequestsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn query_all_dkg_requests(
            ...
            tonic::Response<super::QueryAllDkgRequestsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("side.btcbridge.Query", "QueryAllDKGRequests"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("side.btcbridge.Query", "QueryDKGCompletionRequests"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            ...
            match req.uri().path() {
                ...
                "/side.btcbridge.Query/QueryChainTip" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryChainTipRequest>
                    for QueryChainTipSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_chain_tip(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    for QueryBlockHeaderByHeightSvc<T> {
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                super::QueryBlockHeaderByHeightRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_block_header_by_height(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryBlockHeaderByHash" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryBlockHeaderByHashRequest>
                    for QueryBlockHeaderByHashSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_block_header_by_hash(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryFeeRate" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryFeeRateRequest>
                    for QueryFeeRateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_fee_rate(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryWithdrawalNetworkFee" => {
                    ...
                    > tonic::server::UnaryService<
                        super::QueryWithdrawalNetworkFeeRequest,
                    > for QueryWithdrawalNetworkFeeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_withdrawal_network_fee(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryWithdrawRequestsByTxHash" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<
                        super::QueryWithdrawRequestsByTxHashRequest,
                ...
                "/side.btcbridge.Query/QuerySigningRequests" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QuerySigningRequestsRequest>
                    for QuerySigningRequestsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_signing_requests(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QuerySigningRequestsByAddress" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<
                        super::QuerySigningRequestsByAddressRequest,
                ...
                "/side.btcbridge.Query/QuerySigningRequestByTxHash" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<
                        super::QuerySigningRequestByTxHashRequest,
                ...
                "/side.btcbridge.Query/QueryUTXOs" => {
                    ...
                    impl<T: Query> tonic::server::UnaryService<super::QueryUtxOsRequest>
                    for QueryUTXOsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_utx_os(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryUTXOsByAddress" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryUtxOsByAddressRequest>
                    for QueryUTXOsByAddressSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_utx_os_by_address(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryDKGRequest" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryDkgRequestRequest>
                    for QueryDKGRequestSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_dkg_request(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryDKGRequests" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryDkgRequestsRequest>
                    for QueryDKGRequestsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_dkg_requests(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryAllDKGRequests" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<super::QueryAllDkgRequestsRequest>
                    for QueryAllDKGRequestsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).query_all_dkg_requests(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Query/QueryDKGCompletionRequests" => {
                    ...
                    impl<
                        T: Query,
                    > tonic::server::UnaryService<
                        super::QueryDkgCompletionRequestsRequest,
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn submit_block_headers(
            ...
            tonic::Response<super::MsgSubmitBlockHeadersResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("side.btcbridge.Msg", "SubmitDepositTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("side.btcbridge.Msg", "SubmitWithdrawTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn submit_fee_rate(
            ...
            tonic::Response<super::MsgSubmitFeeRateResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("side.btcbridge.Msg", "UpdateTrustedNonBtcRelayers"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("side.btcbridge.Msg", "UpdateTrustedOracles"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn withdraw_to_bitcoin(
            ...
            tonic::Response<super::MsgWithdrawToBitcoinResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn submit_signatures(
            ...
            tonic::Response<super::MsgSubmitSignaturesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn consolidate_vaults(
            ...
            tonic::Response<super::MsgConsolidateVaultsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn initiate_dkg(
            ...
            tonic::Response<super::MsgInitiateDkgResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn complete_dkg(
            ...
            tonic::Response<super::MsgCompleteDkgResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn transfer_vault(
            ...
            tonic::Response<super::MsgTransferVaultResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            ...
            match req.uri().path() {
                "/side.btcbridge.Msg/SubmitBlockHeaders" => {
                    ...
                    impl<
                        T: Msg,
                    > tonic::server::UnaryService<super::MsgSubmitBlockHeaders>
                    for SubmitBlockHeadersSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).submit_block_headers(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/SubmitDepositTransaction" => {
                    ...
                    impl<
                        T: Msg,
                    > tonic::server::UnaryService<super::MsgSubmitDepositTransaction>
                    for SubmitDepositTransactionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).submit_deposit_transaction(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/SubmitWithdrawTransaction" => {
                    ...
                    impl<
                        T: Msg,
                    > tonic::server::UnaryService<super::MsgSubmitWithdrawTransaction>
                    for SubmitWithdrawTransactionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).submit_withdraw_transaction(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/SubmitFeeRate" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgSubmitFeeRate>
                    for SubmitFeeRateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).submit_fee_rate(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/UpdateTrustedNonBtcRelayers" => {
                    ...
                    impl<
                        T: Msg,
                    > tonic::server::UnaryService<super::MsgUpdateTrustedNonBtcRelayers>
                    for UpdateTrustedNonBtcRelayersSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::MsgUpdateTrustedNonBtcRelayers,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                ...
                "/side.btcbridge.Msg/UpdateTrustedOracles" => {
                    ...
                    impl<
                        T: Msg,
                    > tonic::server::UnaryService<super::MsgUpdateTrustedOracles>
                    for UpdateTrustedOraclesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).update_trusted_oracles(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/WithdrawToBitcoin" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgWithdrawToBitcoin>
                    for WithdrawToBitcoinSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).withdraw_to_bitcoin(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/SubmitSignatures" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgSubmitSignatures>
                    for SubmitSignaturesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).submit_signatures(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/ConsolidateVaults" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgConsolidateVaults>
                    for ConsolidateVaultsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).consolidate_vaults(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/InitiateDKG" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgInitiateDkg>
                    for InitiateDKGSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).initiate_dkg(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/CompleteDKG" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgCompleteDkg>
                    for CompleteDKGSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).complete_dkg(request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/side.btcbridge.Msg/TransferVault" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgTransferVault>
                    for TransferVaultSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                (*inner).transfer_vault(request).await
                            };
                            Box::pin(fut)
                        }
                    }
